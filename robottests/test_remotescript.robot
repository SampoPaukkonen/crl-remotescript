...
Set Original Default Target Properties
    FOR     ${key}  IN  @{DEFAULT_TARGET.keys()}
        Set Default Target Property
        ...     property_name=${key}
        ...     property_value=${DEFAULT_TARGET["${key}"]}
    END
...
Test RemoteScript Set Default Target Property
    ...
    ${tprop}=   Get Target Properties  target=default
    Dictionary Should Contain Sub Dictionary  ${prop}   ${tprop}
    [Teardown]  Set Original Default Target Properties
